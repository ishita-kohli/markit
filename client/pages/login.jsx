  ...
  const submitHandler = async (e) => {
    ...
    return(
            ...
            <div className="title">
                ...
                <p className='w-3/4 mx-auto text-gray-400'>Welcome back! Please enter your details</p>
            </div>
          ...
          onChange={(e) => setEmail(e.target.value)}
            ...
            <p className='text-center text-gray-400 '>
                don't have an account yet? <a href='/signup' className='text-purple-500' >Sign Up</a>
            </p>
        </section>
